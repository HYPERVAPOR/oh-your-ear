...
export function Login() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      {/* The nameplate the landing page and the app's header wear, in the same 1200px box
          as every other screen: this page is one of the app's, and it should not be the
          only one without the app's chrome. No language or theme keys beside it — this
          page is a form, not a room. */}
      <header className="border-b border-hairline px-6">
        <div className="mx-auto flex min-h-16 max-w-[1200px] items-center py-2">
          <Nameplate />
        </div>
      </header>
